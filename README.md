...
![JSONEditor table mode screenshot](https://raw.githubusercontent.com/digiv3rse/json-editor/main/misc/jsoneditor_table_mode_screenshot.png)
...
<https://github.com/digiv3rse/json-editor/blob/main/src/lib/types.ts>

## Styling

The editor can be styled using the available CSS variables. A full list with all variables can be found here:

<https://github.com/digiv3rse/json-editor/blob/main/src/lib/themes/defaults.scss>
...
## Differences between `digiv3rse/json-editor` and `josdejong/jsoneditor`

This library [`digiv3rse/json-editor`](https://github.com/digiv3rse/json-editor/) is the successor of [`josdejong/jsoneditor`](https://github.com/josdejong/jsoneditor). The main differences are:

|              | `josdejong/jsoneditor`                                                                                               | `digiv3rse/json-editor`                                                                                                                                                                                         |
| ------------ | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
A workaround is to add the following to your `vite.config.js` file ([read more](https://github.com/digiv3rse/json-editor/issues/185)):
